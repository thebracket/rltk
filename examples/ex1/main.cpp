...
int main()
{
	...
	//register_font_load("16x16", "../assets/terminal16x16.png", 16, 16);
	//register_font_load("32x32", "../assets/terminal32x32.png", 32, 32);
	//register_font_load("8x16", "../assets/VGA8x16.png", 8, 16);
